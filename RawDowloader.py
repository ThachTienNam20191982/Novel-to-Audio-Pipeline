...
# SAVE_PATH = "Raw"
# LOG_FILE  = "RawDownloader_log.log"
...
#     Loại bỏ hoàn toàn quảng cáo nhưng cũng bỏ mọi style gốc của trang.
#     Tắt nếu truyện bị mất hoặc bị rỗng sau khi rebuild.
#     """
#     driver.execute_script("""
...
#             }
#             // Fallback: div dài nhất
#             let best = null, maxLen = 0;
#             document.querySelectorAll('div').forEach(el => {
#                 const len = (el.innerText || '').length;
#                 if (len > maxLen) { maxLen = len; best = el; }
#             });
#             return best;
#         }
