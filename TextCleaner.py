...
# INPUT_DIR = "Translate"
# OUTPUT_DIR = "Cleaned"
# KEYWORD_FILE = "Keyword.log"

# HEAVY_DELETE_THRESHOLD = 10  # %
...
#         removed_pct = (1 - clean_len / raw_len) * 100 if raw_len else 0

#         total_raw += raw_len
#         total_clean += clean_len

#         print(f"📄 {fname}")
#         print(f"   Raw: {raw_len} | Clean: {clean_len} | Removed: {removed_pct:.1f}%")

#         if removed_pct >= HEAVY_DELETE_THRESHOLD:
#             heavy_files.append((fname, removed_pct))
...
#         if count >= 5:
#             if should_add_suspected(line, delete_keys, keep_keys):
...
#     print(f"Total: {total_raw} → {total_clean}")
#     print(f"Removed: {total_pct:.1f}%")

#     print("\n🧠 New suspected:", len(new_suspected))

#     # ===== HEAVY DELETE =====
#     if heavy_files:
#         print("\n⚠️ File bị xóa nhiều:")
#         for fname, pct in sorted(heavy_files, key=lambda x: -x[1]):
#             print(f" - {fname}: {pct:.1f}%")
#     else:
#         print("\n✅ Không có file bị xóa quá nhiều")
